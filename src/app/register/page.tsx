  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-saffron-50/40 to-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-saffron-700 hover:text-saffron-800 text-sm font-medium"
        >
          <ArrowLeft className="w-4 h-4" /> Back to Home
        </Link>

        <div className="mt-6 mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Family Registration</h1>
